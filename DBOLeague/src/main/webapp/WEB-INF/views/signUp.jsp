			...
			<div class="join">
				...
				<div class='formindiv'>
					...
					<label><input id="member_pw" name="member_pw"
						autocomplete="off" type="password" maxlength="16"></label> <a
						class="help">(영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 8자~16자)</a>
				</div>

				<div class='formindiv'>
					<p>비밀번호 확인*</p>
					<label><input type="password" name="memPw_confirm"
						id="memPw_confirm" value="" autocomplete="off" maxlength="16"></label>
				</div>

				<div class='formindiv'>
					<p>닉네임*</p>
					<input id="member_nick" name="member_nick" type="text" maxlength="10">
				</div>

				<div class='formindiv'>
					<p>E-mail</p>
					<input id="member_email" name="member_email" type="text" maxlength="80">
				</div>
			</div>
			
			<div id="join_btn" class="join_btn">
				<a href="#none" class="join_submit_btn" id="join_submit_btn">회원가입</a>
			</div>
